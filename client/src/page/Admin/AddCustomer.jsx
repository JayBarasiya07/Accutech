...
const AddCustomer = () => {
  ...
  const validate = () => {
    ...
    // Numeric validations
    if (customer.srNo && isNaN(customer.srNo)) newErrors.srNo = "SrNo must be a number";
    if (customer.mobile && !/^\d{10}$/.test(customer.mobile)) newErrors.mobile = "Enter a valid 10-digit mobile";
      ...
      <Col md={10} className="p-4">
        ...
        <Form onSubmit={handleSubmit}>
          ...
          <Row className="mb-3">
            ...
            <Col md={3}><Form.Label>Cooling</Form.Label><Form.Control name="cooling" value={customer.cooling} onChange={handleChange} /></Col>
          </Row>

          {/* Row 5 */}
          <Row className="mb-3">
            <Col md={3}><Form.Label>Room Age</Form.Label><Form.Control name="roomAge" value={customer.roomAge} onChange={handleChange} isInvalid={!!errors.roomAge} />
